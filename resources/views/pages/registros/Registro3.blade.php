...
<head>
  <meta charset="Utf-8">
  <title>Registro Atención al Cliente</title>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <div class="section">
        <div class="section-header">EN REGISTRO</div>
      ...
      <div class="section">
        <div class="section-header">EN ESPERA PREFERENCIAL</div>
        <div class="number">-numero-</div>
      </div>
    </div>
    <div class="sub-container">
      <div class="section">
        <div class="section-header">Números Atendidos</div>
      ...
      <div class="section">
        <div class="section-header">LLAMAR REGISTRO</div>
